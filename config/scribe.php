...
return [
    ...
    'description' => 'API REST para gestión de tickets con autenticación Sanctum y versionado V1/V2',
    ...
    'auth' => [
        ...
        'extra_info' => 'Para obtener tu token, realiza una petición POST a <code>/api/v2/login</code> con tus credenciales. El token se encuentra en la respuesta dentro de <code>data.token</code>.',
    ],
